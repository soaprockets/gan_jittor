...
def add_all_arguments(parser, train):
    ...
    parser.add_argument('--dataroot', type=str, default='/home/hexufeng/Data/gan_jittor/competition/landscape_comp', help='path to dataset root')
    ...
    parser.add_argument('--label_nc', type=int, default=29, help='the number of label')
